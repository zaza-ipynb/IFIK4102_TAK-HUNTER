...
<body style="background-color: rgb(255,255,255);">
    <nav class="navbar navbar-light navbar-expand-md navbar navbar-expand-lg fixed-top" id="mainNav" style="background-color: #ffffff;">
        <div class="container"><a class="navbar-brand js-scroll-trigger" href="Home(Belum Login).php" style="color: #f4476b;"><strong>&nbsp;TAK</strong><i class="fas fa-eye" style="font-size: 22px;"></i><strong>Hunter</strong><br></a><button data-toggle="collapse" class="navbar-toggler navbar-toggler-right"
    ...
    <div class="login-clean" style="background-color: #66d7d7;padding-bottom: 60px;">
        <form action ="SignIn.php" class="text-center" data-aos="fade" method="POST" style="margin-top: 75px;margin-bottom: 20px;">
            ...
            <a class="forgot" href="#">Forgot your nim or password?</a>
